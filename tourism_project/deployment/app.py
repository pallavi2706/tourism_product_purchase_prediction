...
model_path = hf_hub_download(repo_id="pal27/best_tourism_model_v1", filename="best_tourism_model_v1.joblib")
...
NumberOfTrips = st.number_input("NumberOfTrips", min_value=1.0, max_value=50)
